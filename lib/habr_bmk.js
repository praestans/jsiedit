...
jsiedit_fn_editor_start = function()
{
	...
	if (bounds)
	{
		...
		tarea.style.width = (bounds[0].parentNode.clientWidth - 10)+ 'px'; // Установим ширину редактора
		tarea.style.height = Math.min(window.innerHeight / 2, rect.height) + 'px'; // Зададим высоту редактора
